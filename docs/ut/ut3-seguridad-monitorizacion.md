...
Esta unidad sigue el orden de un trabajo real de seguridad: primero se mide, luego se cierra, luego se cifra y al final se documenta. Aquí tienes qué vas a saber hacer al terminar, los conceptos y herramientas que se usan y el plan de las cuatro sesiones.
