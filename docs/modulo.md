...
|------------|-----------|-----:|
| Prácticas evaluables UT1, UT2 y UT3 | Informe de observabilidad, repositorio de alarmas e informe de seguridad de la monitorización | 40 % de la 1ª evaluación |
| Examen 1ª evaluación (10 dic 2026) | UT1 a UT3, prueba práctica en el laboratorio | 60 % de la 1ª evaluación |
| Prácticas evaluables UT4, UT7 y UT8 | Dossier de operación; informe de vulnerabilidades y actualización; acta de baja | 40 % de la 2ª evaluación |
| Examen 2ª evaluación (8 abr 2027) | UT4, UT7 y UT8, prueba práctica en el laboratorio | 60 % de la 2ª evaluación |
| Formación en empresa | UT5 y UT6 con ficha de evidencias firmada por el tutor | Según el plan de FE del centro |

Los exámenes son las sesiones 19 (10 de diciembre de 2026) y 41 (8 de abril de 2027), integradas en el calendario de cada evaluación. Cada práctica evaluable lleva su tabla de criterios y pesos al final de la unidad. Una entrega fuera de plazo sin causa justificada se corrige sobre el 50 %.
